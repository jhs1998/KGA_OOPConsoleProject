...
{
    public class FactoryAreaBattleScene : Scene
    {
        ...
        public FactoryAreaBattleScene(Game game) : base(game)
        {
        }
        ...
        public override void Enter()
        {
            ...
            {
                monster = new Monster("공장장", 600, 20, 5, 2000, 4, 0, 200, "특대 폭탄");
            }
            else if (a == 0)
            {
                monster = new Monster("공장 반장", 400, 20, 5, 1000, 2, 0, 100, "수류탄 투척");
            }
            else if (a == 1)
            {
                monster = new Monster("공장 사원", 200, 15, 1, 200, 1, 0, 70, "세게 치기");
            }
            else if (a == 2)
            {
                monster = new Monster("공장 경호원", 400, 30, 4, 400, 2, 0, 70, "조준 사격");
            }
